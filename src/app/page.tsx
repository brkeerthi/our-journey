  ...
  return (
    <div className="h-screen overflow-hidden bg-white">
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-4 z-30 bg-white/80 backdrop-blur-sm shadow-lg rounded-full px-4 py-2 flex items-center gap-2 hover:bg-white transition-colors duration-200 group md:w-auto md:bottom-6 md:right-auto md:left-8"
      >
